  ...
  return (
    <>
      ...
      <div className={`fixed top-0 left-0 bottom-0 w-[85%] max-w-[320px] bg-white z-[101] shadow-2xl transition-transform duration-500 ease-out flex flex-col ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        {/* Header */}
        <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-[#FDFBFF]">
          <div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          <div className="space-y-4">
            <button
              ...
              className="w-full text-left py-3 border-b border-gray-50 text-[14px] font-bold text-[#1A142E] flex items-center justify-between group"
            >
            ...
            {categories.map((category) => (
              <div key={category.id} className="border-b border-gray-50 last:border-0 pb-4">
                ...
                {expandedRoot === category.id && category.children && (
                  <div className="ml-4 space-y-2 mt-2 animate-in slide-in-from-top-4 duration-300">
